...
void Render()
{
    ...
    XMFLOAT4 vLightDirs[5] =
    {
        XMFLOAT4( -0.4f, 0.4f, -0.4f, 1.0f ), // stationary
        XMFLOAT4( 0.5f, 0.5f, -1.0f, 1.0f ), // moving
		XMFLOAT4(0.7f, -0.7f, 0.7f, 1.0f), // stationary
		XMFLOAT4(-0.5f, -0.5f, 1.0f, 1.0f), // moving
		XMFLOAT4(-1.0f, -1.0f, 0.5f, 1.0f),
    };
    XMFLOAT4 vLightColors[5] =
    {
        XMFLOAT4( 0.0f, 0.0f, 0.5f, 1.0f ), // blue
	...
	// Rotate 3rd light opposite direction
	XMMATRIX mRotate2 = XMMatrixRotationY(2.0f * t);
	XMVECTOR vLightDir2 = XMLoadFloat4(&vLightDirs[3]);
	vLightDir2 = XMVector3Transform(vLightDir2, mRotate2);
	XMStoreFloat4(&vLightDirs[3], vLightDir2);

	XMMATRIX mKeyboardMovement = XMMatrixTranslation(b, a, c);
	XMVECTOR vLightDir3 = XMLoadFloat4(&vLightDirs[4]);
	vLightDir3 = XMVector3Transform(vLightDir3, mKeyboardMovement);
	XMStoreFloat4(&vLightDirs[4], vLightDir3);
	...
	cb1.vLightDir[3] = vLightDirs[3];
	cb1.vLightDir[4] = vLightDirs[4];
	cb1.vLightColor[0] = vLightColors[0];
	cb1.vLightColor[1] = vLightColors[1];
	cb1.vLightColor[2] = vLightColors[2];
	cb1.vLightColor[3] = vLightColors[3];
	cb1.vLightColor[4] = vLightColors[4];
